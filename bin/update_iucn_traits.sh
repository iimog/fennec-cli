...
# import trait table
python `dirname $0`/import_traits_tsv.py -t "IUCN Threat Status" -u $WEBUSER_ID -p --db-user $DB_USER --db-password $DB_PW --db-name $DB_NAME --db-host $DB_HOST --db-port $DB_PORT iucn_traits.tsv
